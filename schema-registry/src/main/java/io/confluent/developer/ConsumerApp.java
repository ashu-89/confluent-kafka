...
public class ConsumerApp {
     ...
     public void consumePurchaseEvents() {
        ...
        // Duplication of configs loaded from confluent.properties to emphasize what's needed to use SchemaRegistry
         consumerConfigs.put("schema.registry.url", "https://psrc-xqq6z.us-central1.gcp.confluent.cloud");
         consumerConfigs.put("basic.auth.credentials.source", "USER_INFO");
         consumerConfigs.put("basic.auth.user.info", "KVI4FNYTJLIKLAIB:RISScuZIhLKliW3A2b0ScQiMOmKieEgygrxnLu1Uy9i874rBmC4jby7PlGjO+HFo");
