...
public class ProducerApp {
    ...
    public void producePurchaseEvents() {
        ...
        producerConfigs.put("schema.registry.url", "https://psrc-xqq6z.us-central1.gcp.confluent.cloud");
        producerConfigs.put("basic.auth.credentials.source", "USER_INFO");
        producerConfigs.put("basic.auth.user.info", "KVI4FNYTJLIKLAIB:RISScuZIhLKliW3A2b0ScQiMOmKieEgygrxnLu1Uy9i874rBmC4jby7PlGjO+HFo");
